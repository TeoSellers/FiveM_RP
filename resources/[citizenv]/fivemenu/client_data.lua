...
changeYourJob = {
  {name="Pôle Emploi", colour=15, id=351, x=-601.59295654297, y=-116.45598602295, z=41.734840393066},
}

jobsname = {"Sans Emploi", "Éboueur", "Mineur", "Chauffeur de taxi", "Livreur de bois", "Livreur de citerne", "Livreur de conteneur", "Livreur de médicaments", "Policier", "Ambulancier" }
...
jobs = {
  ...
  {name="Livreur de bois", id=5},
  {name="Livreur de citerne", id=6},
  {name="Livreur de conteneur", id=7},
  {name="Livreur de médicament", id=8},
  --{name="Policier", id=9},
  --{name="Ambulancier", id=10},
}
...
informateur = {
    {name="informateur", id=52, x=-614.04730224609, y=-142.0407409668, z=39.034908294678 },
